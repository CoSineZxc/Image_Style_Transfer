...
import copy
from img_op import image_loader, image_unloader, img_show
from Loss import ContentLoss, GramMatrix, StyleLoss
from NN_Crt import run_style_transfer
...
def Img_Style_Transfer(Style_imgdir, Cont_imgdir):
    ...
    cnt = cnt.split('.')[0]
    image_unloader("Img/result/" + stl + "_" + cnt + ".jpg", output, imgheight, imgwidth)
